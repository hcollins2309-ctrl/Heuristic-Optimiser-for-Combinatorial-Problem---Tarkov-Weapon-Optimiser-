# COMMENTS TO GPT FOR LESSONS
# Any comments other than these at the beginning are not my writing. They do not represent my understanding.
# Inputs come from a simple CSV file. They only contain the attachment information currently.
# Output is currently displayer in a very simple tkinter GUI
# Best is currently determined as a balance between Ergo & recoil (High ergo, low recoil).
# Price constraints and forced attachments make the process of finding the best solution quite complicated.
